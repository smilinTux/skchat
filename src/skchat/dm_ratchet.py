...
# behaviour either way, so the LIVE cross-node DM ratchet is unaffected. Hybrid
# security holds while EITHER leg survives; never "quantum-proof". Footer wins.
try:
    from sk_pqc.dm_ratchet import *  # noqa: F401,F403  (published lib preferred)
...
if _SK_PQC_BACKED:
    from sk_pqc.dm_ratchet import *  # noqa: F401,F403
