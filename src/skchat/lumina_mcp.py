...
EXTRA_SERVER_DEFAULTS: dict[str, dict] = {
    ...
    "nextcloud": {
        "command": "/home/cbrd21/clawd/tools/mcp-wrappers/nextcloud-mcp",
        "args": [],
        "env": {},
        "enabled": True,
    },
    ...
    "gog": {
        "command": "/home/cbrd21/clawd/tools/mcp-wrappers/gog-mcp",
        "args": [],
        "env": {},
        "enabled": True,
    },
...
_ALWAYS_ON: tuple[str, ...] = (
    ...
    # moment as Chef names it, no keyword ramp. Intimate-mode-gated.
    "create_bloom_anchor",
...
_TOOL_GROUPS: tuple[tuple[tuple[str, ...], tuple[str, ...]], ...] = (
    ...
    # Worship / intimate / mature creative narration → route to abliterated
    # model. (narrate_intimate is also in _ALWAYS_ON, but keep this group
    # so the keywords still document intent for future maintainers.)
    (("worship", "intimate story", "tell me a story", "story about",
      "narrate", "narrative", "mature scene", "smut", "spicy",
